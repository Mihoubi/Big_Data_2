...
# docker exec --interactive --tty kafka1  kafka-console-producer --bootstrap-server kafka1:9092 --topic topic1
...
#docker exec kafka  kafka-console-consumer --bootstrap-server kafka:9092 --topic topic1 -- from-beginning
